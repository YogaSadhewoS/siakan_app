                ...
                <table id="table" class="ui celled table table-bordered" style="width:100%;">
                    ...
                    <tbody>
                        @foreach ($kartografis as $kartografi)
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a href="#" class="dropdown-item btn-info btn-sm me-2"
                                                    ...
                                                    data-bs-target="#modalDetail{{ $kartografi->id }}">Show</a>
                                            </li>
                                            @can('admin')
                                                <li>
                                                    <a href="{{ route('arsipkartografi.edit', $kartografi->id) }}"
                                                        class="dropdown-item btn-primary btn-sm me-2">Edit</a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('arsipkartografi.destroy', $kartografi->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                            ...
                            <!-- Modal Detail -->
                            <div class="modal fade" id="modalDetail{{ $kartografi->id }}" tabindex="-1"
                                aria-labelledby="modalDetailLabel{{ $kartografi->id }}" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <dl class="row" style="margin-left:100px; color: #999;">
                                                ...
                                                <dd class="col-sm-8">
                                                    {{ Carbon::parse($kartografi->kurun_waktu)->format('d M Y') }}</dd>
