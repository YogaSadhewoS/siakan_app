...
<title>Restore Arsip Kartografi</title>
    ...
    <!-- <div class="card rounded-0" style="width: 100%;"> -->
        ...
        <div class="card-body mr-20 ml-20">
            ...
            <div class="card-header py-6 ">
                        <h6 class="m-2 h2 font-weight-bold" style="color: #E36159;">Kumpulan Data Terbuang Arsip Kartografi</h6>
                        ...
                        <tr>
                            ...
                            <div class="dropdown" style="background-color: #E36159; padding-right:10px">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @can('admin')
                                        <li>
                                            <a href="{{ route('arsipkartografi.restore', $kartografi->id) }}" class="dropdown-item btn-primary btn-sm me-2" onclick="return confirm('Apakah anda yakin ingin mengembalikan data?')">
                                                Restore
                                            </a>
                                        </li>
                                        <li>
                                            <form action="{{ route('arsipkartografi.hardDelete', $kartografi->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
