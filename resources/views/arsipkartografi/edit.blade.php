...
@section('content')
    ...
    <title>Arsip Kartografi | Edit</title>
    ...
    <body>
        <div class="card rounded-0" style="width: 100%;">
            ...
            <form method="POST" action="{{ route('arsipkartografi.update', $kartografi->id) }}" class="center mr-40 ml-40 mt-10" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="fonds" name="fonds" placeholder="Fonds"
                            aria-describedby="inputGroupPrepend2" required value="{{ old('fonds', $kartografi->fonds) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="seri_arsip" name="seri_arsip" placeholder="Seri Arsip" required value="{{ old('seri_arsip', $kartografi->seri_arsip) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="file" name="file" placeholder="File" required value="{{ old('file', $kartografi->file) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="number" class="form-control" id="nomor_urut" name="nomor_urut" placeholder="Nomor Urut" required value="{{ old('nomor_urut', $kartografi->nomor_urut) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode" required value="{{ old('kode', $kartografi->kode) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul" required value="{{ old('judul', $kartografi->judul) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="isi_informasi" name="isi_informasi" placeholder="Isi Informasi" required value="{{ old('isi_informasi', $kartografi->isi_informasi) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="date" class="form-control" id="kurun_waktu" name="kurun_waktu" placeholder="Kurun Waktu" required value="{{ old('kurun_waktu', $kartografi->kurun_waktu) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="volume" name="volume" placeholder="Volume" required value="{{ old('volume', $kartografi->volume) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="text" class="form-control" id="ukuran" name="ukuran" placeholder="Ukuran" required value="{{ old('ukuran', $kartografi->ukuran) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 mb-4">
                        <input type="text" class="form-control" id="penerbit" name="penerbit" placeholder="Penerbit" required value="{{ old('penerbit', $kartografi->penerbit) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="text" class="form-control" id="skala" name="skala" placeholder="Skala" required value="{{ old('skala', $kartografi->skala) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="text" class="form-control" id="referensi" name="referensi" placeholder="Tunjuk Silang" required value="{{ old('referensi', $kartografi->referensi) }}">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-3 mb-4">
                        <input type="hidden" name="oldImage" value="{{ $kartografi->image }}">
                        @if($kartografi->image)
                        <img src="{{ asset('storage/' . $kartografi->image) }}" class="img-preview img-fluid mb-3">
                        @else
